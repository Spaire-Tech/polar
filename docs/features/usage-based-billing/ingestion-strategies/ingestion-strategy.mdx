...
Spaire offers an ingestion framework to work with Spaire's event ingestion API.
...
We're always looking for ways to improve our ingestion strategies. Feel free to contribute — [Spaire Ingestion SDK](https://github.com/spairehq/spaire-ingestion).
