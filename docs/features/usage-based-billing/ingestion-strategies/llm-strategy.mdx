...
Our Python SDK includes an ingestion helper and strategies for common use cases. It's installed as part of the Spaire SDK.
...
The ingestion helper is a simple wrapper around the Spaire events ingestion API. It takes care of batching and sending events to Spaire in the background, without blocking your main thread.
...
With our PydanticAI strategy, you can easily track the usage of LLMs and send the data to Spaire for billing.
