---
title: "Custom Fields"
description: "Learn how to add custom input fields to your checkout with Spaire"
---
...
With Spaire, you can easily add such fields to your checkout using **Custom Fields**.
