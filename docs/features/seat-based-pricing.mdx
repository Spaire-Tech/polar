...
- **Customer ID** (if customer already exists in Spaire)
...
To use seat-based pricing features, ensure you have the latest version of the Spaire SDK installed:
- TypeScript/JavaScript: `npm install @spaire/sdk@latest`
- Python: `pip install --upgrade spaire-sdk`
