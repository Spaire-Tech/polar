...
The customer portal is directly available from the URL `https://www.spairehq.com/your-org-slug/portal`. Your customers will be able to authenticate there by entering the email they used to purchase or subscribe to your products.
...
Using the Spaire API, all you need is to call the `customerSessions` endpoint. Here’s an example using our TypeScript SDK.
...
export const GET = CustomerPortal({
  ...
  server: 'sandbox' // Use sandbox if you're testing Spaire - pass 'production' otherwise
});
```