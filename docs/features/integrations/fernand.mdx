---
title: "Spaire Integration in Fernand"
sidebarTitle: "Fernand"
description: "Learn how to sync customer and payment data from Spaire to Fernand."
---
...
After connecting your [Spaire](https://www.spairehq.com/) account to Fernand, you’ll be able to see customer payment information and product access details directly within each customer conversation.
...
## How to connect Fernand with Spaire
...
2. Click on **Connect Spaire**.
3. You'll be redirected to Spaire to authorize the connection.
4. Once approved, Fernand will begin syncing customer data automatically.

That’s it! You’ll now see Spaire customer info directly in Fernand's conversation list and sidebar.

---

## How to automate your inbox with Spaire data

Once Spaire is connected, you can create automation rules in Fernand based on Spaire data.
...
<Steps>
  ...
  <Step title="Select a condition">
    Now add a condition based on Spaire data. For example:
...
If you ever want to disconnect Spaire from your Fernand workspace:
<Steps>
<Step title="Go to the Integrations page."></Step>
<Step title="Click Disconnect next to Spaire."></Step>
</Steps>

Deleting your organization on Fernand will also remove the Spaire integration automatically.
