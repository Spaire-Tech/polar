---
title: "Affonso Affiliates with Spaire"
sidebarTitle: "Affonso Affiliates"
---

This guide explains how to integrate
[Affonso](https://affonso.io)'s affiliate marketing software with your Spaire
...
### 1. Create a Spaire Access Token for Affonso

First, you'll need to create an API token in Spaire that Affonso can use to communicate with your account:

1. Login to your **Spaire Dashboard**
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Spaire_Affonso_1.mp4"
  type="video/mp4" />
</video>


### 2. Set Up Webhooks in Spaire

After connecting your Spaire account with Affonso, you'll [receive a webhook URL and secret from Affonso](https://affonso.io/app/affiliate-program/connect). Add these to your Spaire account:

1. Go to **Settings** → **Developers** → **Webhooks** in your Spaire Dashboard
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Spaire_Affonso_2.mp4"
  type="video/mp4" />
</video>
...
### 5. Pass Referral Data to Spaire Checkout
...
// Create checkout session with Spaire
...
3. When the user makes a purchase, the referral ID is passed to Spaire as metadata
4. Spaire's webhook notifies Affonso about the purchase
...
More details about the integration: [Spaire Affiliate Program](https://affonso.io/spaire-affiliate-program)
