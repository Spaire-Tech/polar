...
Trials are a great way to let potential customers experience your product before committing to a subscription. With Spaire, you can easily set up free trials for your subscription products.
...
When this feature is enabled, Spaire tracks trial redemptions using:
