...
Automating Discord server invites and roles for customers or subscribers is super easy and powerful with Spaire.
...
<img
  ...
  src="/assets/features/benefits/discord/create.dark.png"
/>

Click on `Connect your Discord server`. You'll be redirected to Discord where you can grant the Spaire App for your desired server.
...
Ability to kick members who have this benefit and connected Discord with Spaire.

### **Create Invite**

Ability to invite members who purchase a product or subscribes to a tier with this benefit.

You're now redirected back to Spaire and can finish setting up the Discord benefit on our end.
