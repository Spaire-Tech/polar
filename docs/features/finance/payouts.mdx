...
description: "Easily withdraw money from your Spaire account at any time"
---
...
Since we're the Merchant of Record, your customers get an invoice from Spaire. Thus, for your accounting, you need to issue an invoice to Spaire for the amount we paid out to you. To ease this process, we can automatically generate a **reverse invoice** for you, detailing the sells we made on your behalf, minus our fees.

You can generate them from the **Payouts** page under **Finance** in your Spaire dashboard. Click on the ellipsis next to the payout you want to generate a reverse invoice for, and select **Download invoice**.
...
- Customize the invoice number. By default, we generate one like `SPAIRE-0001`, but you can change it to your own format and sequence.
...
<iframe src="https://spaire-public-assets.s3.us-east-2.amazonaws.com/sample-reverse-invoice.pdf" width="100%" height="600px" />
