...
<img src="https://www.spairehq.com/docs/assets/features/checkout/embed/demo.png" />
...
const openCheckout = async () => {
  ...
  try {
    ...
    const checkout = await SpaireEmbedCheckout.create(checkoutLink, {
      theme,
    });
...
To enable wallet payment methods on your embedded checkout, please [email us](mailto:support@spairehq.com) with:
