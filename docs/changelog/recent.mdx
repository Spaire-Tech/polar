...
<Update label="2025-10-17">
  ...
  [Benefits](https://www.spairehq.com/docs/features/benefits/introduction) attached to the subscription are now automatically revoked when the subscription is canceled.
...
Need to perform actions in Spaire? [Reach out to us](/support) with your use case and we'll consider adding more actions in the future.
