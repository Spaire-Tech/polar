...
- https://sandbox.spairehq.com/dashboard/ORG_SLUG/settings (Sandbox)
- https://www.spairehq.com/dashboard/ORG_SLUG/settings (Production)
...
- https://sandbox.spairehq.com/dashboard/ORG_SLUG/settings/webhooks (Sandbox)
- https://www.spairehq.com/dashboard/ORG_SLUG/settings/webhooks (Production)
