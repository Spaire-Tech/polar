...
<Steps>
  ...
  <Step title="Configure BetterAuth Server">
    ...
    ```typescript BetterAuth Server with Spaire Example icon=square-js
  ...
  <Step title="Configure BetterAuth Client">
    ...
    ```typescript BetterAuth Client with Spaire Example icon=square-js
...
<Steps>
  ...
  <Step title="Create checkouts using BetterAuth client">
    ...
    ```typescript BetterAuth Checkout with Spaire Example icon=square-js
    ...
    ```typescript BetterAuth Checkout with Spaire Organization Example icon=square-js
