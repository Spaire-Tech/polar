...
Merchants of Record offer yet another layer of convenient abstraction to facilitate digital orders on top of the underlying PSPs and transactions. E.g Spaire is built on Stripe (+ more PSPs in the future).
...
- ✅ The platform (Spaire) handles international taxes by being a reseller of your digital goods & services. Of course, without being in the way of your relationship with your customers.
...
So how does Spaire offer a Merchant of Record (MoR) service and handle international sale taxes? All other Merchants of Record simply state they handle it internationally - don't worry about it. We do too.
...
1. **Capturing**. Charging the Swedish consumer \$12.5/month and saving \$2.5/month for the Swedish tax authorities. Stripe Tax is an excellent service to automate this and the one Spaire uses today.
...
As your Merchant of Record, Spaire is liable for tax compliance globally on all sales internationally via our platform, hosted- or embedded checkoutsfrom payments anywhere in the world.

**Current Spaire Tax Registrations**

1. Spaire, Inc. is incorporated as a US Delaware C Corp and will register for US State Sales Taxes upon reaching thresholds
...
2. Spaire with a 1.1% premium vs. Stripe would need to help facilitate \$109,090 in sales for the given market in order for it to cover our accounting costs (\$1,200/1.1%)
...
We consider MoR a key value-add to Spaire, but not the sole reason for Spaire to exist. Our ambition is to be the easiest way to monetize for developers. However, we're never going to be the right solution for all use cases. But we'll always salute and help anyone who ships software - regardless of billing platform.

## Frequently Asked Questions

<AccordionGroup>
  <Accordion title="What is Spaire's VAT number?">
    Spaire's VAT number is `EU372061545`. This is an EU One Stop Shop (OSS) registration, which allows non-EU businesses like Spaire (a Delaware C Corporation) to handle VAT for all EU countries through a single registration in Ireland.
  </Accordion>
