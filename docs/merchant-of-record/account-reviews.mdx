As a Merchant of Record (MoR), we act as the reseller of digital goods and services. Therefore, we need to make sure that businesses using Spaire complies with our [acceptable products & use](/merchant-of-record/acceptable-use) policies. Combined with continuously monitoring, reviewing and preventing fraud, unacceptable use, bad actors and high risk accounts.
...
1. A quick survey about your business, products and intended use case with Spaire.
...
To maintain platform integrity and ensure smooth operations, we have established clear guidelines for merchants using Spaire.
...
1. Invite the new admin to the team via `Settings` > `Members` in the Spaire dashboard
2. Ask that new admin to complete identity verification under `Finance` > `Account` after logging in via that email in the Spaire dashboard
...
If you need assistance with changing organization ownership or have special circumstances, please contact [support@spairehq.com](mailto:support@spairehq.com).
