...
<Steps>
    ...
    <Step title =  "Go to the Products Catalogue">
        ...
        You can also go directly to `https://www.spairehq.com/dashboard/${org_slug}/products`.
...
<Steps>
    <Step title = "Create a Checkout Link using the API">
        ...
        ```bash Terminal
        curl --request POST \
            --url https://api.spairehq.com/v1/checkout-links/ \
        ...
        ```
    Find all the available parameters along with the description in the  [Create Checkout Link API](https://www.spairehq.com/docs/api-reference/checkout-links/create).
    </Step>
    <Step title="Open the Checkout Link URL">
        ...
        ```json
        {
            "...": "...",
            "...": "...",
            "url": "https://buy.spairehq.com/spaire_cl_..." // [!code ++]
        }
        ```
        It looks like below:
    ...
    <Step title = "Change the order of products">
        ...
        ```bash Terminal
        curl --request POST \
            --url https://api.spairehq.com/v1/checkouts/ \
            --header 'Authorization: Bearer <YOUR_ACCESS_TOKEN>' \
            --header 'Content-Type: application/json' \
            --data '{
            "products": [
...
<Steps>
    <Step title = "Create a Checkout Session using the API">
        ...
        ```
    Find all the available parameters along with the description in the [Create Checkout Session API](https://www.spairehq.com/docs/api-reference/checkouts/create-session).
    </Step>
    <Step title="Open the Checkout Session URL">
        ...
        {
            "...": "...",
            "url": "https://buy.spairehq.com/spaire_c_...", // [!code ++]
            "...": "..."
        }
        ```
        It looks like below:
