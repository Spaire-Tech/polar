...
description: "Learn how to grant meter credits to customers before they make any purchase using the Spaire API."
---
...
1. Create a customer in Spaire (if they don't exist)
...
If your customer doesn't already exist in Spaire, you need to create them first.

### Option A: Create via Dashboard

<Steps>
  <Step title="Navigate to Customers">
    In the Spaire dashboard sidebar, click on **Customers**.
  </Step>
