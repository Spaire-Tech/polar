...
By passing either `customer_id` or `external_customer_id` when creating a checkout session, Spaire will:
...
If you've already created a customer in Spaire and have their Spaire customer ID, you can use it directly.

<Steps>
    <Step title = "Get the Customer ID">
        Retrieve the customer ID from your Spaire dashboard or through the [Customers API](/api-reference/customers/list).
...
If you have your own user management system, you can use your internal customer ID. This is the recommended approach as it makes reconciliation between your system and Spaire easier.
