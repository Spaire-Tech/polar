...
description: "Learn how create product variants in Spaire and how customers can easily switch between them in the customer portal."
---
...
<Steps>
    <Step title = "Navigate to Checkout Links in the dashboard">
        In the Spaire dashboard sidebar, navigate to **Products** > **Checkout Links**.
        You can also go directly to:  
        `https://www.spairehq.com/dashboard/${org_slug}/products/checkout-links`
