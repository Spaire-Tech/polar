# Setup Usage-Based Billing — Claude Code Adapter

This is the Claude Code adapter for the shared Setup Usage-Based Billing playbook.

**Read and execute the full playbook at:**
> `docs/agent-playbooks/setup-usage-billing.md`
