    ...
    <div className="flex flex-col gap-6 max-w-2xl">
      ...
      <div className="flex items-center gap-3">
        ...
        {(['text', 'video'] as const).map((ct) => (
          <button
            key={ct}
            onClick={() => setEdits((prev) => ({ ...prev, content_type: ct }))}
            className={cn(
      ...
      {edits.content_type === 'video' ? (
        <div>
          ...
          <input
            ...
            onChange={(e) => setEdits((prev) => ({ ...prev, videoUrl: e.target.value }))}
            placeholder="https://..."
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) => setEdits((prev) => ({ ...prev, textContent: e.target.value }))}
          ...
          {selectedLesson ? (
            ...
            <div className="flex h-full flex-col items-center justify-center gap-3 text-center">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gray-100">
                <TextSnippetOutlined className="text-gray-400" sx={{ fontSize: 28 }} />
              </div>
              <p className="text-sm font-medium text-gray-600">Select a lesson to edit</p>
