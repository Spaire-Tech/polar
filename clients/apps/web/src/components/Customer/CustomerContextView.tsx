...
export const CustomerContextView = ({
  ...
  return (
    <div className="flex h-full flex-col gap-2 overflow-y-auto">
      <ShadowBox className="dark:border-spaire-800 flex flex-col gap-6 border-gray-200 bg-white p-6 md:shadow-xs lg:rounded-2xl">
        <Link
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <div className="dark:text-spaire-500 flex flex-row items-center gap-1 text-sm text-gray-500">
              {customer.email}
            </div>
          </div>
        </Link>
      ...
      <ShadowBox className="dark:border-spaire-800 flex flex-col gap-4 border-gray-200 bg-white p-6 md:gap-0 md:shadow-xs lg:rounded-2xl">
        {!customer.deleted_at && (
          <DetailRow
