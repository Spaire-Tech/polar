...
export const CustomerContextView = ({
  ...
  return (
    <div className="flex h-full flex-col gap-2 overflow-y-auto">
      <ShadowBox className="flex flex-col gap-6 border-none p-6 lg:rounded-2xl">
        <Link
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-row items-center gap-1 text-sm text-polar-500">
              {customer.email}
            </div>
          </div>
        </Link>
      ...
      <ShadowBox className="flex flex-col gap-4 border-none p-6 md:gap-0 lg:rounded-2xl">
        {!customer.deleted_at && (
          <DetailRow
      ...
      <ShadowBox className="flex flex-col gap-4 border-none p-6 lg:rounded-2xl">
