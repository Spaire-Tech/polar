        ...
        >
          ...
          >
            <motion.div
              ...
              className={twMerge(
                'dark:bg-spaire-900 relative z-10 flex h-full max-h-full w-full flex-col overflow-y-auto bg-white shadow-sm md:fixed md:top-0 md:right-0 md:bottom-0 md:h-auto md:w-[540px] dark:text-white',
                className,
              )}
...
export const CloseButton = (props: {
  ...
  return (
    <button
      type="button"
      className={twMerge(
        'dark:text-spaire-100 dark:hover:text-spaire-300 text-black hover:text-gray-800',
        props.className,
      )}
      onClick={() => props.hide()}
      tabIndex={-1}
