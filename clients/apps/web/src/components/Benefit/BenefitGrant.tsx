...
const BenefitGrantCustom = ({
  ...
  return (
    <ShadowBox className="p-6 lg:rounded-3xl">
      <div className="prose prose-invert prose-headings:font-medium prose-headings:text-white prose-h1:text-2xl prose-h2:text-xl prose-h3:text-lg prose-h4:text-sm prose-h5:text-sm prose-h6:text-sm text-polar-300 prose-p:text-sm leading-normal [&>*>*:first-child]:mt-0">
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="flex flex-row items-center gap-x-4">
        <div className="flex flex-row items-center gap-x-2 text-xs text-white">
          <span className="flex h-8 w-8 flex-row items-center justify-center rounded-full bg-white/[0.06] text-sm">
            {resolveBenefitIcon(benefit.type, 'h-3 w-3')}
          </span>
        </div>
        <div className="flex flex-col">
          <h3 className="text-sm font-medium">{benefit.description}</h3>
          <p className="flex flex-row gap-x-1 truncate text-sm text-polar-500">
