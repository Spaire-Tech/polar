...
function ShareSpaceButtons({ spaceUrl, orgName }: { spaceUrl: string; orgName: string }) {
  ...
  const shareMessage = 'I just launched my Spaire Space\n\nAll my work is up here now!'
  ...
  const shareOnTwitter = () => {
    window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(shareMessage)}&url=${encodeURIComponent(spaceUrl)}`, '_blank')
  }
