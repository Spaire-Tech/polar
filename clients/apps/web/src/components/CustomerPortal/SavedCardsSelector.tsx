              ...
              <button
                ...
                className={`w-full rounded-lg border p-3 text-left transition-colors ${
                  isSelected
                    ...
                    : 'dark:border-spaire-700 dark:hover:bg-spaire-800 border-gray-200 hover:bg-gray-50'
              ...
              >
                <div className="flex items-center gap-3">
                  <CreditCardBrandIcon
                    width="2.5em"
                    brand={brand}
                    className="dark:border-spaire-700 shrink-0 rounded-sm border border-gray-200 p-1"
                  />
                  <div className="grow">
