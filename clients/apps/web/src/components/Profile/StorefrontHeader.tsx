...
export const StorefrontHeader = ({ organization }: StorefrontHeaderProps) => {
  ...
  return (
    <div className="flex w-full grow flex-col items-center gap-y-6">
      <div className="relative aspect-3/1 w-full rounded-2xl bg-gray-100 md:aspect-4/1 md:rounded-4xl">
        <canvas
          id="gradient-canvas"
          className="absolute top-0 right-0 bottom-0 left-0 h-full w-full rounded-2xl md:rounded-4xl"
        />
        <Avatar
          className=" absolute -bottom-16 left-1/2 h-32 w-32 -translate-x-1/2 border-8 border-white text-lg md:text-5xl"
