...
const ProgressIndicator = ({
  ...
  return (
    <div className="relative">
      ...
      <div className="dark:bg-spaire-700 absolute top-6 right-6 left-6 h-0.5 bg-gray-200" />

      {/* Progress bar fill */}
      <div
        className="dark:bg-spaire-400 absolute top-6 left-6 h-0.5 bg-gray-500 transition-all duration-500 ease-out"
        style={{
            ...
            <div key={step.id} className="relative flex flex-col items-center">
              <div
                className={`flex h-12 w-12 items-center justify-center rounded-full border-2 transition-all duration-300 ${
                  isCompleted
                    ? 'dark:bg-spaire-400 dark:text-spaire-950 dark:border-spaire-400 border-gray-500 bg-gray-500 text-white'
                    : isPending
                      ...
                      : isFailed
                        ...
                        : isCurrent
                          ? 'border-blue-500 bg-blue-400 text-white'
                          : isBlocked
                            ? 'dark:bg-spaire-800 dark:border-spaire-600 border-gray-300 bg-gray-100 text-gray-400'
                            : 'dark:bg-spaire-900 dark:border-spaire-600 border-gray-300 bg-white text-gray-400'
              ...
              <div className="mt-3 max-w-24 text-center">
                <p
                  className={`text-xs font-medium ${
                    isCompleted
                      ? 'dark:text-spaire-300 text-gray-600'
                      : isPending
                        ? 'dark:text-spaire-300 text-gray-600'
                        : isFailed
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-8">
      ...
      <div className="space-y-2 text-center">
        ...
        <p className="dark:text-spaire-400 text-gray-600">
