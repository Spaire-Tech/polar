  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-3 text-center">
        ...
        <p className="dark:text-spaire-400 mx-auto max-w-2xl text-lg text-gray-600">
      ...
      {isAccountSetupComplete ? (
        <StepCard>
          <div className="space-y-4 text-center">
            <div className="dark:bg-spaire-800 rounded-lg bg-gray-50 p-8">
        ...
        <StepCard
          className={isNotAdmin ? 'dark:border-spaire-600 border-gray-300' : ''}
        >
          {isNotAdmin ? (
            <div className="space-y-4">
              <div className="space-y-4 text-center">
                <div className="dark:bg-spaire-800 dark:border-spaire-600 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-8">
                  <div className="mb-4 flex justify-center">
                    <div className="dark:bg-spaire-700 flex h-12 w-12 items-center justify-center rounded-full bg-gray-200">
                      <UserCheck className="dark:text-spaire-400 h-6 w-6 text-gray-500" />
                    </div>
                  </div>
                  <h4 className="dark:text-spaire-400 mb-2 font-medium text-gray-600">
                    Account Setup Restricted
                  </h4>
                  <p className="dark:text-spaire-500 mx-auto mb-4 max-w-md text-sm text-gray-500">
                  ...
                  <p className="dark:text-spaire-400 mt-3 text-xs text-gray-500">
            ...
            <div className="space-y-4">
              <div className="space-y-4 text-center">
                <div className="dark:bg-spaire-800 rounded-lg bg-gray-50 p-8">
                  ...
                  <p className="dark:text-spaire-400 mx-auto mb-6 max-w-md text-sm text-gray-600">
