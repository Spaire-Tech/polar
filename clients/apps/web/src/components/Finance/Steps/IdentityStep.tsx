            ...
            <div className="dark:bg-spaire-800 rounded-lg bg-gray-50 p-8">
              {identityVerificationStatus === 'pending' ? (
                ...
                <>
                  ...
                  <p className="dark:text-spaire-400 mx-auto text-sm text-gray-600">
                    Your identity has been successfully verified.
                  </p>
                </>
              ) : identityVerificationStatus === 'failed' ? (
                ...
                <>
                  <div className="mb-4 flex justify-center">
                    <div className="dark:bg-spaire-900/30 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100">
                      <CheckCircle className="dark:text-spaire-400 h-4 w-4 text-gray-600" />
                    </div>
                  </div>
