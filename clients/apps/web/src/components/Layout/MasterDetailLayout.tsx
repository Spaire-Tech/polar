    ...
    >
      {listView ? (
        <motion.div
          ...
          className="glass-card h-full w-full overflow-y-hidden rounded-2xl border-none md:max-w-[300px] xl:max-w-[320px]"
        >
          {listView}
        </motion.div>
      ) : null}

      <div className="relative flex w-full flex-col items-center rounded-2xl px-4 md:overflow-y-auto md:px-8">
        <motion.div
          className={twMerge(
