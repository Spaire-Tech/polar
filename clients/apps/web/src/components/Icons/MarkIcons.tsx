...
export const MarkGrid = ({ size = 32 }: { size?: number }) => (
  <MarkWrap size={size}>
    <rect
      x="4"
      y="4"
...
export const MarkStore = ({ size = 32 }: { size?: number }) => (
  <MarkWrap size={size}>
    <path
      d="M4 11 L7 5 L25 5 L28 11 L28 13 L4 13 Z"
      fill={MARK_PALETTE.amber}
      opacity="0.9"
    />
    <rect
...
export const MarkLayers = ({ size = 32 }: { size?: number }) => (
  <MarkWrap size={size}>
    <path
    ...
    />
    <path
      d="M16 16 L28 22 L16 28 L4 22 Z"
      fill={MARK_PALETTE.cyan}
      opacity="0.85"
    />
  </MarkWrap>
...
export const MarkSliders = ({ size = 32 }: { size?: number }) => (
  <MarkWrap size={size}>
    <rect
      x="4"
      y="7"
      ...
      opacity="0.95"
    />
    <circle cx="11" cy="8.5" r="4" fill={MARK_PALETTE.amber} opacity="0.9" />
    <rect
      x="4"
      y="22"
      width="24"
...
export const MarkCoin = ({ size = 32 }: { size?: number }) => (
  <MarkWrap size={size}>
    <ellipse
      cx="16"
      cy="20"
...
export const MarkCode = ({ size = 32 }: { size?: number }) => (
  <MarkWrap size={size}>
    <path
      d="M11 9 L4 16 L11 23"
      stroke={MARK_PALETTE.blueDk}
      strokeWidth="3"
      strokeLinecap="round"
      strokeLinejoin="round"
      fill="none"
    />
    <path
      d="M21 9 L28 16 L21 23"
      stroke={MARK_PALETTE.violetDk}
      strokeWidth="3"
      strokeLinecap="round"
      strokeLinejoin="round"
      fill="none"
