...
export const DetailRow = ({
  ...
  return (
    <div className="flex flex-col text-sm md:flex-row md:items-baseline md:justify-between md:gap-4">
      ...
      <span
        className={twMerge(
          ' group flex flex-1 flex-row flex-nowrap items-center justify-between gap-x-2 rounded-md transition-colors duration-75 md:px-2.5 md:py-1 hover:md:bg-gray-100',
          value ? '' : ' text-gray-500',
          valueClassName,
        )}
      >
