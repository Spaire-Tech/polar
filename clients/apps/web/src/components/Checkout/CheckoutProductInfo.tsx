    ...
    <div className="contents">
      <div className="flex flex-col gap-y-6 md:gap-y-8">
        ...
        {product.name ? (
          ...
          <div className="dark:bg-spaire-700 h-6 w-48 animate-pulse rounded-md bg-gray-200" />
        )}
      </div>
      ...
      {product.description && (
        <div className="prose dark:prose-invert prose-headings:mt-8 prose-headings:font-medium prose-headings:text-black prose-h1:text-2xl prose-h2:text-xl prose-h3:text-lg prose-h4:text-md prose-h5:text-sm prose-h6:text-sm dark:prose-headings:text-white dark:text-spaire-300 max-w-4xl leading-normal text-gray-800">
