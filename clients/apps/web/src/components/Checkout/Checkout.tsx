...
const Checkout = ({ embed: _embed, theme: _theme }: CheckoutProps) => {
  ...
  return (
    <div className="flex w-full flex-col gap-y-6">
      <ShadowBoxOnMd className="md:dark:border-spaire-700 dark:md:bg-spaire-900 grid w-full auto-cols-fr grid-flow-row auto-rows-max gap-y-12 divide-gray-200 rounded-3xl md:grid-flow-col md:grid-rows-1 md:items-stretch md:gap-y-24 md:divide-x md:overflow-hidden md:border md:border-gray-100 md:bg-white md:p-0 md:shadow-xs dark:divide-transparent">
        <div className="md:dark:bg-spaire-950 flex flex-col gap-y-8 md:bg-gray-50 md:p-12">
          {checkout.returnUrl && (
            <Link
              href={checkout.returnUrl}
              className="dark:text-spaire-500 flex flex-row items-center gap-x-4 px-4 py-2 text-gray-500"
            >
