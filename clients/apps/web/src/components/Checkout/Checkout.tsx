...
const Checkout = ({ embed: _embed, theme: _theme }: CheckoutProps) => {
  ...
  if (embed) {
    return (
      <ShadowBox className="dark:md:bg-polar-900/80 flex flex-col gap-y-12 divide-gray-200 overflow-hidden rounded-3xl md:bg-white/90 md:shadow-lg md:backdrop-blur-xl dark:divide-transparent">
  ...
  return (
    <div className="flex w-full flex-col gap-y-6">
      <ShadowBoxOnMd className="md:dark:border-polar-700 dark:md:bg-polar-900 grid w-full auto-cols-fr grid-flow-row auto-rows-max gap-y-12 divide-gray-200 rounded-3xl md:grid-flow-col md:grid-rows-1 md:items-stretch md:gap-y-24 md:divide-x md:overflow-hidden md:border md:border-gray-100/80 md:bg-white/80 md:p-0 md:shadow-lg md:backdrop-blur-xl dark:divide-transparent dark:md:border-polar-700/50 dark:md:bg-polar-900/80">
        <div className="md:dark:bg-polar-950/60 flex flex-col gap-y-8 md:bg-gray-50/60 md:p-12">
          {checkout.returnUrl && (
            <Link
