...
export const Link = ({ variant = 'primary', ...props }: LinkProps) => {
  ...
  return (
    <NextLink
      {...props}
      className={twMerge(
        'border-spaire-200 focus-within:bg-spaire-200 hover:bg-spaire-200 flex w-fit cursor-default flex-row gap-x-1 py-px font-mono focus-within:text-black focus-within:outline-none hover:text-black',
