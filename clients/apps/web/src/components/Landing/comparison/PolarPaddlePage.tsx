  ...
  return (
    <ResourceLayout title="Polar vs Paddle" toc={tocItems}>
      ...
      <ResourceSection id="comparison" title="Feature Comparison">
        <div className="dark:border-spaire-700 overflow-x-auto border border-gray-200">
      ...
      <ResourceSection id="pricing" title="Pricing">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="dark:border-spaire-700 flex flex-col gap-4 border border-gray-200 p-6">
            <div className="flex flex-col gap-2">
              <h3 className="text-lg font-medium">Polar</h3>
              <div className="text-4xl">4% + 40¢</div>
              <p className="dark:text-spaire-300 text-sm text-gray-500">
                per transaction
              </p>
            </div>
            <ul className="dark:divide-spaire-700 flex flex-col divide-y divide-gray-200">
              <li className="flex items-start gap-2 py-2">
                <CheckOutlined className="text-green-600" fontSize="small" />
                <span className="dark:text-spaire-300 text-sm text-gray-600">
      ...
      <ResourceSection id="developer-experience" title="Developer Experience">
        <div className="flex flex-col gap-4">
          ...
          <ul className="dark:border-spaire-700 dark:divide-spaire-700 divide-y divide-gray-200 border-y border-gray-200 [&>li]:py-3">
            <li>
      ...
      <ResourceSection id="transparency" title="Transparency & Control">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="dark:bg-spaire-800 flex flex-col gap-3 bg-gray-50 p-6">
            <h4 className="font-medium">With Polar</h4>
            <ul className="flex flex-col gap-2">
              <li className="dark:text-spaire-300 flex items-start gap-2 text-sm text-gray-600">
                <CheckOutlined className="text-green-600" fontSize="small" />
