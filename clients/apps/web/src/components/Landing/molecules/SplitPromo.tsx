...
export const SplitPromo: React.FC<SplitPromoProps> = ({
  ...
  return (
    <motion.div
      className={`flex w-full flex-col overflow-hidden rounded-2xl md:flex-row md:rounded-4xl ${reverse ? 'md:flex-row-reverse' : ''} dark:bg-spaire-900 bg-white md:items-stretch`}
