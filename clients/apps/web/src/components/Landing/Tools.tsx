...
export const Tools = () => {
  return (
    <div className="dark:bg-spaire-900 flex w-full flex-col gap-y-16 rounded-4xl bg-white p-8 md:p-16">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
        <div className="dark:bg-spaire-800 flex w-full flex-col gap-y-4 rounded-3xl bg-gray-50 p-8">
