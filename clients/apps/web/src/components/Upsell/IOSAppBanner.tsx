...
export const IOSAppBanner = () => {
  ...
  return (
    <div className="dark:bg-spaire-900 dark:border-spaire-800 relative flex flex-col gap-3 rounded-xl border border-gray-200 bg-white p-6 pt-8 text-sm md:hidden">
      <button
        type="button"
        onClick={dismiss}
        className="dark:text-spaire-500 dark:hover:text-spaire-300 absolute top-4 right-4 cursor-pointer text-gray-400 transition-colors hover:text-gray-600"
        aria-label="Dismiss"
      >
      ...
      <div className="flex flex-col gap-1">
        <span className="font-medium">Spaire is now available on App Store</span>
