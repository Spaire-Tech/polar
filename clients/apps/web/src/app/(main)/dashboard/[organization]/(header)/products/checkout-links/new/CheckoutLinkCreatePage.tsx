...
export const CheckoutLinkCreatePage = ({
  ...
  return (
    <div className="flex h-full overflow-hidden">
      {/* Left panel — form */}
      <div className="dark:border-spaire-700 flex w-[480px] shrink-0 flex-col overflow-hidden border-r border-gray-200">
        <div className="dark:border-spaire-700 border-b border-gray-200 px-6 py-4">
          <Link
