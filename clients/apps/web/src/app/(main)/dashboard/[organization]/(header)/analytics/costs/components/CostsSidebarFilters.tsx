  ...
  return (
    <div
      className={twMerge(
        ...
        hasScrolled && 'border-t border-white/[0.06]',
      )}
...
function EventStatisticsCard({
  ...
  return (
    <Link
      ...
      className={twMerge(
        'flex cursor-pointer flex-col justify-between gap-5 rounded-2xl border bg-white/[0.04] px-3 pt-2 pb-3 transition-colors',
        isSelected
          ? 'border-white/[0.12]'
    ...
    >
      <div className="flex flex-col justify-between gap-1.5">
        ...
        <dl className="flex max-w-sm items-center gap-4 font-mono text-polar-500">
      ...
      <div className="-m-2 flex flex-1 flex-col rounded-xl bg-white/[0.04] p-1">
