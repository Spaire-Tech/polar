...
// The editable course landing, alone on the page — the document the Landing
// tab's phone frame irames. It runs its own edit pipeline (optimistic saves,
// undo/redo via ⌘Z/⌘⇧Z) against the same server as the desktop canvas; the
// desktop side refetches when the creator switches back.
