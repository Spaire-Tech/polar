    ...
    <div className="mx-auto flex h-full min-h-screen w-full max-w-6xl flex-col gap-y-8 md:gap-y-24">
      <div className="flex w-full flex-col items-center gap-y-8">
        <div className="flex flex-col items-center gap-y-8 py-12 text-center lg:max-w-2xl">
          ...
          <p className="dark:text-spaire-500 text-2xl text-balance text-gray-500">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          {downloads.map((link) => (
            <Link
              ...
              className={twMerge(
                'dark:hover:bg-spaire-900 dark:border-spaire-700 flex w-full cursor-pointer flex-col gap-6 border border-gray-300 p-6 transition-colors duration-200 hover:bg-gray-100',
              )}
              href={link.href ?? '#'}
              target={link.target}
            >
