...
export default async function Page(props: {
  ...
  return (
    <form
      className="dark:bg-spaire-950 flex h-screen w-full grow items-center justify-center bg-gray-50"
      method="POST"
    ...
    >
      <div className="flex w-80 flex-col items-center gap-4">
        ...
        <div className="dark:text-spaire-400 text-center text-gray-500">
