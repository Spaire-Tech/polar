...
export const List = ({ children, className, size = 'default' }: ListProps) => {
  return children ? (
    <div
      className={twMerge(
        'dark:divide-spaire-700 dark:border-spaire-700 flex flex-col divide-y divide-gray-200 overflow-hidden border border-gray-200',
    ...
    <div
      className={twMerge(
        ...
        selected
          ...
          : 'dark:hover:bg-spaire-800 hover:bg-gray-50',
