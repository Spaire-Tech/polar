...
const SelectTrigger = ({
  ...
  <SelectTriggerPrimitive
    ref={ref}
    className={twMerge(
      ' flex cursor-pointer flex-row gap-x-2 rounded-xl border border-gray-200 bg-white px-3 shadow-xs transition-colors hover:border-gray-300',
      className,
    )}
    {...props}
  >
...
const SelectContent = ({
  ...
  <SelectContentPrimitive
    ref={ref}
    className={twMerge(' rounded-xl border-none', className)}
    {...props}
  >
    {children}
  </SelectContentPrimitive>
