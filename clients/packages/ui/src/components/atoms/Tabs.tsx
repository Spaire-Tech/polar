...
const TabsTrigger = ({
  ...
  <TabsTriggerPrimitive
    ref={ref}
    className={twMerge(
      ' cursor-pointer px-4 text-gray-400 hover:text-black data-[state=active]:rounded-xl data-[state=active]:bg-gray-100 data-[state=active]:text-blue-500 data-[state=active]:shadow-none',
