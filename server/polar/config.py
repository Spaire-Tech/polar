...
class Settings(BaseSettings):
    ...
    # Discord (used for embed icons; override in production via env var)
    FAVICON_URL: str = "https://app.spairehq.com/favicon.png"
    THUMBNAIL_URL: str = "https://app.spairehq.com/spaire-logo-dark.png"
